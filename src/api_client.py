...
class CurrencyApiClient:
	...
	async def _get(self, session: ClientSession, endpoint: str) -> dict:
		try:
			...
			logging.error(f'Error while fetching CurrencyAPI {endpoint}: {trace(e)}')
		except BaseException as e:
			logging.error(f'Unhandled error CurrencyAPI {endpoint}: {trace(e)}')
